...
(function () {
  ...
  const api = {
    ...
    createOwner() { return run(async()=>{
      ...
      await mergeAccounts();render();showPanel();flash('Владелец создан. Сохраните пароль: восстановления нет.');
    }); },
